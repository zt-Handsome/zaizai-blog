...
<!-- > 首发博客：[崽崽的小窝](https://zt-handsome.github.io/zaizai-blog/) 欢迎star，一起学习！博客主页有吹水群，扫码加入！ -->
...
const objectArr: IItem[] = [{ id: 1, name: '崽崽', isGod: true }];
// or
const objectArr: Array<IItem> = [{ id: 1, name: '崽崽', isGod: true }];
