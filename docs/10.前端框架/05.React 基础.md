...
<!-- - [ 线上预览：崽崽 React 学习系统](https://zt-handsome.github.io/zaizai-blog/study) -->
...
<!-- ，或者直接访问[崽崽学习系统 LifeCycle](https://zt-handsome.github.io/zaizai-blog/study/#/demo)。还有些其他的生命周期，`componentDidCatch, UNSAFE_componentWillMount()`等等，简单了解下就行。 -->
